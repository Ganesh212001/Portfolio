        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-16">
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="mt-2 text-gray-600">This Is Todo App It Was pure React App A to-do app, also known as a task manager or task list, This Is Fully Responsive Website You can use In Any Device</p>
              </div>
            <div className='flex flex-row justify-around mb-5'>
